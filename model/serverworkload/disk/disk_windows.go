...
var (
	procGetDiskFreeSpaceExW     = utils.Modkernel32.NewProc("GetDiskFreeSpaceExW")
	procGetLogicalDriveStringsW = utils.Modkernel32.NewProc("GetLogicalDriveStringsW")
	procGetDriveType            = utils.Modkernel32.NewProc("GetDriveTypeW")
	procGetVolumeInformation    = utils.Modkernel32.NewProc("GetVolumeInformationW")
)
...
func Partitions() ([]PartitionStat, error) {
	return PartitionsWithContext(context.Background())
}
