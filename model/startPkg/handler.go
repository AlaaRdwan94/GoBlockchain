...
func HandleRequest() {
	...
	myRouter.Handle("/02ad27a1f7d1dd3da57e", globalPkg.IsAdmine(errorPkgModule.DeleteError)).Methods("DELETE", "OPTIONS")
	myRouter.Handle("/5w81f7d1dd3d01726cej", globalPkg.IsAdmine(errorPkgModule.DeleteErrorsBetweenTwoTimes)).Methods("DELETE", "OPTIONS")
	//proof of stake
	...
	//myRouter.Handle("/{Path}", account.ResetPassword).Methods("PUT", "OPTIONS")
	// myRouter.Handle("/{Path}", account.ResetPassword).Methods("PUT", "OPTIONS")
